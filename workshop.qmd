...
%%| fig-height: 600px
flowchart TD
  A("<b>Litany</b>\nA fact, claim, or observation")
  B(<b>Mental model</b>\nRepresentation of the system and its causes)
  C(<b>Mental epistemology</b>\nPsychological processes that justify mental models)
%%  E(Worldview, environmental/conspiracist) ---> 
%%  F(Ideology, political, populist + values)
%%  G(Identity expression) ---> person and social
%%  H(Emotions) ---> phobias, worries (e.g., climate change), disgust?
%%  J(Epistemic motivations + thinking styles/biases) ---> need for cognitive consistency (can group with ontology and strength of priors), inuitive vs analytical thinking thinking, suitability of scientific method, [maybe, cognitive biases]
%% Mental epistemology can be psych. needs, habits/defaults
  C ---> A ---> C
  A <---> B <---> C
%%  C --- E & F & G & H & J & K & I
```
...
## A working model of anti-science attitudes: litanies

- Litanies are public descriptions
- Can form a social truth
- E.g., newspaper headlines, tweets
- Rarely 'the full picture'
- Litanies may not be completely anti-science (truth is not always clear)
- Anti-science litanies may be imbued with a unfalsifiable claim or demand

## Anti-climate-science litanies
![](assets/cook_2021-climate-scepticism.webp){width=100% fig-align="center"}

## Activity

::: {.callout-tip icon=false}
## Activity: What are some anti-science litanies about your own field?

Brainstorm some examples of anti-science litanies about your own field.
...
- Activity is to brainstorm related stuff
- Where does information/litanies come from?
- Who is trusted?



# All notes after this slide
