...
## The truth underpinning anti-science
...
flowchart LR
  A(<p><b>Claim</b>\nFacts, observations, or predictions</p>)
  B(<p><b>Mental model</b>\nRepresentation of the system and its causes</p>)
  C("<p><b>Worldviews</b>\nFundamental understandings of the world<ul><li>What is true (society, culture, environment)?</li><li>What is truth (how is it made, who makes it?)</li></ul></p>")
  C ---> A ---> C
  A <---> B <---> C
```
...
## The goodness underpinning anti-science
