...
![](assets/cook_2021-climate-scepticism.webp){height="1000" fig-align="center"}
...
- In conversation, have you encountered misconceptions about your field (chatting with stakeholders, dinner with family)?
...
%%| fig-width: 800px
flowchart TD
  A(<font size=6><b>Claim</b>\nA fact, description, or observation)
...
%%  E(Worldview, environmental/conspiracist) +  F(Ideology, political, populist + values) + (ontology) + priors (mental models?) +
