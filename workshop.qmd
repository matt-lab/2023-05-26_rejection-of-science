...
<!-- 
To do 
- Make up some worksheet?
- Fix svg of models
- Ideally, add grid of different cultural @kahan_2007 and environmental examples @price2014
- Maybe add Fabio's example
- Check references
- Write background
- Write agenda
...
- Portion of the public are distrustful of science
- Public may be vulnerable to misinformation about specific sciences
:::
...
- Despite their diversity, anti-science claims may be underpinned by the same psychology
:::
...
Brainstorm some examples of anti-science claims about your own field.
...
%%| fig-width: 800px
flowchart TD
  A("<font size=6><b>Claim</b>\n&ldquo;Scientists should stop falsely claiming that climate change is a settled science.&rdquo;")
...
- "There is an urgent need for sustainable ocean management"
- "Marine ecosystems cannot support ongoing growth without transformational change"
- "Further demands on coasts and oceans are expected"

2. Ask yourself "why do I believe this?" and write down your response.
3. Repeat step 2 and 3 with your new response. Stop once you feel you are going around in circles, or reach something that just "is".
:::
...
- We hold deep understandings about the nature of our world and ourselves
- Culturally transmitted understandings shaped by individual experience [@koltko-rivera_2004]
- These fundamental understandings shape what we say (claim) and how we think (mental model)
- E.g., What is knowledge? What is human nature? What is 'good' and 'bad'? What is an ideal world?

## Worldviews

gif of 40 worldviews by [@koltko-rivera_2004]
...
- Worldviews can be classified on two dimensions [@kahan_2007; @price2014; @hornsey_2021; @douglas_1983]
  1. **Individualism-collectivism**: From self-reliance and competition to collective identity and strong social bonds
  2. **Social stratification**: From role- or class-based social stratification to role inclusivity 
...
- The individualism-collectivism dimension is particularly relevant [@price2014; @kahan_2007]
...
- The individualism-collectivist dimension of worldviews reflects Western left-right ideology
...
- Scientific populism casts scientists and their methods as nefarious elite [@mede_2020;@mede_2022]
...
::: {.callout-tip}
## Activity: The truth underpinning anti-science 

Reflect on your chosen anti-science claim.

1. How might worldviews and ideology support your chosen anti-science claim?
2. What is knowledge to someone who might support your chosen anti-science claim?
:::
...
::: {.callout-tip}
## Activity: The goodness underpinning anti-science 

Reflect on someone who might endorse your chosen anti-science claim.

1. To this person, could adherence to your chosen anti-science claim add good (or reduce bad) in the world?
2. To this person, could opposition to your chosen anti-science claim add bad (or reduce good) in the world?
:::

## The motives underpinning anti-science

- Anti-science underpinned by psychological motives and tendencies [@douglas_2017; @hornsey_2020]
- Psychological motives can shape the logic between layers
...
2. Belief in anti-science claims may satisfy psychological motives
:::
:::
...
2. Messages that emphasise how science can satisfy psychological motives are more likely to be accepted
:::
:::
::::
...
What communication might be effective in changing your chosen anti-science claim?
...
Reflect on the science claim you chose in an earlier activity.
...
- Fundamental understandings privilege some explanations over others to satisfy psychological motives
- Psychological motives can also encourage belief change
- Communication can be more effective when tailored to satisfy psychological motives and when messages are compatible with worldviews
